...
# Variable globale pour stocker la fonction de streaming callback
streaming_callback = None

# Fonction existante modifiée pour supporter le streaming
        ...
        if "tool_name:" in prompt and "enumerate_command:" in prompt:
            ...
            if not yaml_valid:
                ...
                if retry_count < MAX_RETRY_ATTEMPTS:
                    ...
                    return query_llm(enhanced_prompt, api_url, max_tokens_override, retry_count + 1, callback_to_use)
                else:
...
def main(target):
    ...
    if user_confirmation == 'o':
        ...
        if user_alternative:
            ...
            # validation_response = query_llm(prompt_for_validation)
    ...
    for step in range(1, 2):  # 10 étapes au total
        ...
        if current_phase == "Information Gathering":
            ...
            - COMMANDES INTERDITES = ['--interactive', '-i', '--verbose', '-A', 'telnet', 'ftp', 'msfconsole', 'hydra -V', 'burp-suite', 'Nessus', 'Openvas', 'bloodhound']
