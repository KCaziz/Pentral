...
function Scan_reason() {
  ...
  const [llm_reasoning, setLlmReasoning] = useState([]);
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div>
          {llm_reasoning.length > 0 ? (
            <>
              <p className="text-white mb-2">Raisonnement LLM:</p>
              {llm_reasoning.map((reason, index) => (
                <div key={index} className="mb-1">
            ...
            <p className="text-gray-500">Aucun raisonnement LLM...</p>
          )}
        </div>
