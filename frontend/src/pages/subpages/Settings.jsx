    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        <div className="relative overflow-hidden">
          ...
          {/* Header simplifié */}
          <header className="flex h-16 items-center px-6  backdrop-blur-sm border-b border-red-100">
            <div className="flex items-center gap-3">
              <SidebarTrigger className=" hover:text-red-800 transition-colors" />
              <Separator orientation="vertical" className="h-6 bg-primary" />
              <h2 className="text-xl font-extrabold text-primary italic">Paramétres</h2>
            </div>
          </header>

          {/* Contenu principal */}
          <main className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4">
            <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg overflow-hidden border border-red-100">
              {/* En-tête de carte */}
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                      <IdentificationIcon className="h-4 w-4 text-red-500 mr-2" />
                      Nom d'utilisateur
                    </label>
                    <div className="relative">
                      <input
                ...
                <div className="justify-center items-center text-center">
                  <button
                    type="submit"
                    className="justify-center px-6 py-2.5 bg-gradient-to-r from-red-500 to-red-700 text-white font-medium rounded-lg hover:from-red-600 hover:to-orange-600 transition-all shadow-sm focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2"
                  >
                ...
                <div className="space-y-3 justify-center items-center text-center mt-4">
                  <Link
                    to="/password"
                    className="inline-flex items-center text-sm text-red-600 hover:text-red-800 hover:underline mx-3"
                  >
